...
extension AoC2022 {
    class Day07 : AoC2022, Solution {
        ...
        func part01(_ inputData: Input) -> Output {
            let fileSystemTree = AoC2022.Day07.buildTree(with: inputData)
                        
            return AoC2022.Day07.flatten(tree: fileSystemTree)
        ...
        func part02(_ inputData: Input) -> Output {
            let fileSystemTree = AoC2022.Day07.buildTree(with: inputData)
            let availableSpace = AoC2022.Day07.getAvailableSpace(from: fileSystemTree)
            let neededSpace = AoC2022.Day07.targetAvailableSpace - availableSpace
